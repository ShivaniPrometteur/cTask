...
function abc(arr){
    ...
    let arr1=[]
       ...
       for(let i=0;i<arr.length;i++){
          ...
          // console.log(dob)
           let day=Date.parse("2022-08-20 12:00:00")
   
          
           
           
           var milliseconds=day - dob;
          
           
           
           var age=Math.floor(milliseconds/31557600000);    //if we use Math.round() then final output will be [20,18,18]
